...
public: // constructor
    ...
    TriMesh(OptimizationState& optState);

    // initialize from a triangle mesh, V will be constructed from UV_mesh in 2D,
    // V_mesh will be used to initialize restShape
    TriMesh(OptimizationState& optState, const Eigen::MatrixXd& V_mesh, const Eigen::MatrixXi& F_mesh,
    ...
    TriMesh(OptimizationState& optState, Primitive primitive, double size = 1.0, double spacing = 0.1, bool separateTri = true);
